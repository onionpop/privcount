...
'MidTestPurposeTruePositiveCount' : { CIRCUIT_EVENT, CELL_EVENT },
'MidTestPurposeFalsePositiveCount' : { CIRCUIT_EVENT, CELL_EVENT },
'MidTestPurposeFalseNegativeCount' : { CIRCUIT_EVENT, CELL_EVENT },
'MidTestPurposeTrueNegativeCount' : { CIRCUIT_EVENT, CELL_EVENT },

'MidTestPositionTruePositiveCount' : { CIRCUIT_EVENT, CELL_EVENT },
'MidTestPositionFalsePositiveCount' : { CIRCUIT_EVENT, CELL_EVENT },
'MidTestPositionFalseNegativeCount' : { CIRCUIT_EVENT, CELL_EVENT },
'MidTestPositionTrueNegativeCount' : { CIRCUIT_EVENT, CELL_EVENT },

'MidTestWebpageTruePositiveCount' : { CIRCUIT_EVENT, CELL_EVENT },
'MidTestWebpageFalsePositiveCount' : { CIRCUIT_EVENT, CELL_EVENT },
...
'MidPredictRendPurposePredictCGMPositionPredictSiteCircuitCount' : { CIRCUIT_EVENT, CELL_EVENT },
'MidPredictRendPurposePredictCGMPositionPredictNotSiteCircuitCount' : { CIRCUIT_EVENT, CELL_EVENT },
...
def get_classify_counter_labels():
    return set(['MidTestPurposeTruePositiveCount',
